#! /usr/bin/env python
"""
Pandoc filter to convert svg files to pdf copied from https://gist.github.com/jeromerobert/3996eca3acd12e4c3d40
"""
    ...
    if key == 'Image':
       ...
       if mimet == 'image/svg+xml' and option:
           ...
           if mtime < os.path.getmtime(src):
               ...
               subprocess.call(cmd_line, stdout=sys.stderr.fileno(), shell=True)
           if attrs:
